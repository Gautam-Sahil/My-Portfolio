...
// Modal component to ask for user consent
const Modal = ({ onClose, toggle }) => {
  return createPortal(
    <div className="fixed z-40 inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center">
      <div
      ...
      >
        <h2>Do you like to play the background music?</h2>
...
const Sound = () => {
  ...
  const handleFirstUserInteraction = useCallback(() => {
    ...
    // Cleanup event listeners after interaction
